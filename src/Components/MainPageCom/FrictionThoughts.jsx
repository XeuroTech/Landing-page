                    ...
                    const cardarr = [
                      {
                        ...
                        description: "We're everywhere, mobile or desktop, online or offline. Everything is synced in real-time."
                      },
                      {
                        id: 2,
                        icon: <HttpsIcon />,
                        title: "Secure but open",
                        description: "End-to-end encryption keeps your notes secure. Our export and API keeps your notes accessible."
                      }
                    ];
