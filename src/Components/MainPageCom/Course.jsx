...
const Course = ({
    ...
    academyButtonText = "About Us",
    academyHeading = "Empowering Innovation Through Code – Discover Who We Are",
    academyDescription = "At Xeurotech, we blend creativity with cutting-edge technology to deliver software solutions that drive real impact..",
